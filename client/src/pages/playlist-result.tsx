...
export default function PlaylistResult() {
  ...
  const handleShare = () => {
    ...
    // Create URL with dynamic playlist data for social media crawlers
    const baseUrl = window.location.origin + '/playlist-result';
    const urlParams = new URLSearchParams({
      name: playlistData.name || 'Cosmic Playlist',
      description: playlistData.description || 'Cosmic playlist curated by AI based on astrological insights'
    });
