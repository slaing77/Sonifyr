...
export class HarmonicCorrelationEngine {
  ...
  async analyzeTrackCorrelation(
    ...
    try {
      ...
      // Use chart-only analysis (Spotify audio analysis API is restricted as of Nov 2024)
      // This provides astrology-based correlation without requiring audio feature access
